...
pacientes en una sala de emergencias. Cada paciente tiene una categoría de
urgencia (roja, amarilla, verde) y un nombre. El programa debe permitir al
usuario realizar las siguientes operaciones: (2P)
